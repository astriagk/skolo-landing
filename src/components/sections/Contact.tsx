          ...
          <AnimateOnScroll delay={100}>
            <div className="mt-8 space-y-3">
              ...
              >
                ...
                <svg className="h-4 w-4 text-gray-300 ml-auto group-hover:text-primary-400 group-hover:translate-x-1 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              >
                ...
                <svg className="h-4 w-4 text-gray-300 ml-auto group-hover:text-green-500 group-hover:translate-x-1 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              </a>
            </div>
          ...
          <AnimateOnScroll delay={150}>
            <div className="rounded-2xl border border-gray-200 bg-white overflow-hidden h-full shadow-sm hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="bg-gradient-to-br from-primary-50 via-blue-50 to-secondary-50 h-64 flex items-center justify-center relative overflow-hidden">
                {/* Decorative circles */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-24 w-24 rounded-full border-2 border-primary-200/40 animate-ping" style={{ animationDuration: '3s' }} />
                ...
                <div className="text-center relative z-10">
                  ...
                  <p className="font-bold text-gray-800 text-lg">Bangalore, India</p>
