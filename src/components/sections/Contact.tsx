...
import { CONTACT, WHATSAPP_LINK, WHATSAPP_LINK2 } from "@/lib/constants";

export default function Contact() {
  const [expandedCall, setExpandedCall] = useState(false);
        ...
        <div>
          ...
          <AnimateOnScroll delay={150}>
            <div className="mt-8 space-y-3">
              ...
              {/* Call Us Card */}
              <div className="flex items-center gap-4 flex-wrap rounded-2xl border border-gray-200 bg-white p-4 hover:border-primary-200 hover:shadow-md transition-all duration-300">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-primary-100 to-blue-100 text-primary-600">
                  <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                </div>
                <p className="text-sm font-semibold text-gray-900 shrink-0">Call us</p>
                <div className="flex flex-wrap gap-2 ml-auto">
                  <a
                    href={`tel:${CONTACT.phone.replace(/\s/g, "")}`}
                    className="group/num inline-flex items-center gap-2 whitespace-nowrap rounded-xl border border-primary-200 bg-primary-50 px-3 py-1.5 hover:bg-primary-100 hover:border-primary-300 hover:shadow-sm transition-all duration-200"
                  >
                    <span className="text-sm font-semibold text-primary-700 group-hover/num:text-primary-900">{CONTACT.phone}</span>
                  </a>
                  <a
                    href={`tel:${CONTACT.phone2.replace(/\s/g, "")}`}
                    className="group/num inline-flex items-center gap-2 whitespace-nowrap rounded-xl border border-primary-200 bg-primary-50 px-3 py-1.5 hover:bg-primary-100 hover:border-primary-300 hover:shadow-sm transition-all duration-200"
                  >
                    <span className="text-sm font-semibold text-primary-700 group-hover/num:text-primary-900">{CONTACT.phone2}</span>
                  </a>
                </div>
              </div>

              {/* WhatsApp Card */}
              <div className="flex items-center gap-4 flex-wrap rounded-2xl border border-green-200/60 bg-gradient-to-r from-green-50 to-emerald-50/50 p-4 hover:border-green-300 hover:shadow-md hover:shadow-green-100 transition-all duration-300">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-whatsapp text-white shadow-sm shadow-green-500/25">
                ...
                <p className="text-sm font-semibold text-gray-900 shrink-0">WhatsApp</p>
                <div className="flex flex-wrap gap-2 ml-auto">
                  <a
                    href={WHATSAPP_LINK}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group/num inline-flex items-center gap-2 whitespace-nowrap rounded-xl border border-green-300 bg-green-100/70 px-3 py-1.5 hover:bg-green-200/70 hover:border-green-400 hover:shadow-sm transition-all duration-200"
                  >
                    <span className="text-sm font-semibold text-green-700 group-hover/num:text-green-900">{CONTACT.phone}</span>
                  </a>
                  <a
                    href={WHATSAPP_LINK2}
                    target="_blank"
                    ...
                    className="group/num inline-flex items-center gap-2 whitespace-nowrap rounded-xl border border-green-300 bg-green-100/70 px-3 py-1.5 hover:bg-green-200/70 hover:border-green-400 hover:shadow-sm transition-all duration-200"
                  >
                    <span className="text-sm font-semibold text-green-700 group-hover/num:text-green-900">{CONTACT.phone2}</span>
                  </a>
                </div>
              </div>
            </div>
